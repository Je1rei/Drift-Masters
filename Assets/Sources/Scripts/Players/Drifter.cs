...
{
    [FormerlySerializedAs("_InputHandler")] [Space(10)] 
    [SerializeField] private InputHandler _inputHandler;

    [SerializeField] private float _durationToggleButtonsView = 1f;
    [Space(20)] 
    private float _moveSpeed = 35;
    ...
    private void Move()
    {
        ...
        _moveForce = Vector3.Lerp(_moveForce.normalized, _transform.forward, _traction * Time.deltaTime) * _moveForce.magnitude;
    }
